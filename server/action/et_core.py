...
def install(data, *kwargs):
    ...
    shutil.copy2(f'{unzip_temp_dir}/easytier-core', f'{ET_BIN_DIR}/easytier-core')
    shutil.copy2(f'{unzip_temp_dir}/easytier-cli', f'{ET_BIN_DIR}/easytier-cli')
    Path(unzip_temp_dir).unlink()
